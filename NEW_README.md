...
> [!NOTE]
> August 16, 2024 — We have migrated to Go! This means a few things—most importantly **the install instructions from previous Fabric videos won't work because they're based on the legacy (Python) version of Fabric. So be sure to go check the new install instructions below!

## What and why

Since the start of 2023 and the rise of Generative AI we've seen a massive number of AI applications for accomplishing tasks. It's powerful, but _it's not easy to integrate this functionality into our lives._
