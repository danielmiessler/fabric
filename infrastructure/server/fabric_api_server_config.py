...
# Read route configurations from a YAML file
with open("./routes_config.yml", "r") as routes_file:
    routes_config = yaml.safe_load(routes_file)
...
# Define routes based on the external YAML configuration
@app.route('/<route>', methods=["POST"])
# @auth_required  # Require authentication
def handle_route(route):
    if route not in routes_config['prompts']:
    ...
    system_url = f"https://raw.githubusercontent.com/danielmiessler/fabric/main/patterns/{route}/system.md"
    user_url = f"https://raw.githubusercontent.com/danielmiessler/fabric/main/patterns/{route}/user.md"
